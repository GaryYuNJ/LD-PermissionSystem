...
CREATE TABLE RESOURCE    (
	...
	DEVICE_TYPE int(2) COMMENT '设备类型：通行、家居'  ,
	IS_VIRTUAL_RESOURCE  char(1) COMMENT '虚拟资源、真实设备资源' ,
	PERMISSION_ATTR_ID int(2) comment '资源权限属性：公共资源；基础资源(授权时用：针对下层节点的资源来说，如果要使用下层节点，必须使用的上层节点)；私有资源；' ,
